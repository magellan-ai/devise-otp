  ...
  module Controllers
    module Helpers
      ...
      def trusted_devices_enabled?
        resource.class.otp_trust_persistence&.positive?
      end

      def recovery_enabled?
        resource_class.otp_recovery_tokens&.positive?
      end
      ...
      def otp_refresh_credentials_for(resource)
        ...
        session[otp_scoped_refresh_property] = (Time.zone.now + resource.class.otp_credentials_refresh)
      end
      ...
      def otp_set_trusted_device_for(resource)
        ...
        cookies.signed[otp_scoped_persistence_cookie] = {
          httponly: true,
          expires:  Time.zone.now + resource.class.otp_trust_persistence,
